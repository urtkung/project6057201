...
<main>
  <h1 class="slideInDown animated">กรุณาลงชื่อเข้าใช้ก่อนใช้งานด้วย Email และ Password</h1>
  <h1 class="slideInDown animated" id="reset">กรุณาป้อน Email ที่ต้องการรีเซ็ตรหัสผ่าน</h1>
<!-- Log In -->
<section>
    ...
    <div class="login-page">
      ...
      <div class="form">
        ...
        <form class="login-form" action="ac_login.php" method="post" enctype="multipart/form-data">
		  ...
		  <p class="message"> userสำหรับทดสอบ: admin@gmail.com / 123 </a></p>
        </form>
      </div>
    </div>
  </div>
